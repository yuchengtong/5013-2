...
void ReverseOptimizationWorker::DoWork()
{
    bool success = false;
    QString msg;
...
void ReverseOptimizationWorker::RequestInterruption()
{
    m_interrupted = true;
}
