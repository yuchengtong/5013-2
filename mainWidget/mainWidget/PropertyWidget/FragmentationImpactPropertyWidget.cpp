...
void FragmentationImpactPropertyWidget::initWidget()
{
	...
	// 设置列宽度
	QTableWidgetItem* colimnItem = m_tableWidget->item(13, 1);
	...
	QTableWidgetItem* titeItem = new QTableWidgetItem("破片撞击安全性分析");
	...
	m_tableWidget->setItem(13, 2, new QTableWidgetItem(""));
	...
	m_tableWidget->item(13, 2)->setBackground(QBrush(QColor(230, 230, 230)));
