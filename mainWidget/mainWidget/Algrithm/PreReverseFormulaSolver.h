...
private:
    double evaluate(const QString& expr, double A, double B, double C, double D, double E, double F, double G);
    ...
    double parseTerm(const QString& term, double A, double B, double C, double D, double E, double F, double G);
    double parseFactor(const QString& factor, double A, double B, double C, double D, double E, double F, double G);
};
#endif